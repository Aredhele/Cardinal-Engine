...
#ifndef CARDINAL_ENGINE_FXAA_HPP__
#define CARDINAL_ENGINE_FXAA_HPP__
...
private:
    ...
    int m_fxaaSpanID;
    int m_fxaaReduceMulID;
    int m_fxaaReduceMinID;
};

} // !namespace

#endif // !CARDINAL_ENGINE_FXAA_HPP__