...
#ifndef CARDINAL_ENGINE_SHARPEN_HPP__
#define CARDINAL_ENGINE_SHARPEN_HPP__
...
/// \class Sharpen
/// \brief Makes edges sharp
class Sharpen : public PostEffect
{
public:
...
#endif // !CARDINAL_ENGINE_SHARPEN_HPP__