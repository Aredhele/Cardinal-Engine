...
/// \file       TransparentCubeRenderer.hpp
/// \date       13/03/2018
/// \project    Cardinal Engine
/// \package    World/Chunk/Renderer
/// \author     Vincent STEHLY--CALISTO

#ifndef CARDINAL_ENGINE_TRANSPARENT_CUBE_RENDERER_HPP__
#define CARDINAL_ENGINE_TRANSPARENT_CUBE_RENDERER_HPP__
...
/// \class TransparentCubeRenderer
/// \brief Renders all transparent blocks
class TransparentCubeRenderer
{
public:

    /// \brief Constructor
    TransparentCubeRenderer();
...
#endif // !CARDINAL_ENGINE_TRANSPARENT_CUBE_RENDERER_HPP__